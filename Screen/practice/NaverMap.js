...
const MapViewScreen = ({navigation}) => {
    ...
    return <>
        <NaverMapView ref={mapView}
            ...
            <Marker coordinate={P4} onClick={() => console.warn('onClick! p4')} image={require("../assets/icons/marker.png")} width={48} height={48}/>
            ...
            <Marker coordinate={P5} onClick={() => console.warn('onClick! p0')} width={96} height={96}>
                <View style={{backgroundColor: 'rgba(255,0,0,0.2)', borderRadius: 80}}>
                    <View style={{backgroundColor: 'rgba(0,0,255,0.3)', borderWidth: 2, borderColor: 'black', flexDirection: 'row'}}>
                        <Image source={require("../assets/icons/marker.png")} style={{
                            width: 32, height: 32,
                    ...
                    <ImageBackground source={require("../assets/icons/marker.png")} style={{width: 64, height: 64}}>
